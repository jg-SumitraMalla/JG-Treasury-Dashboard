 ...
 * 
 * Redirect URIs are configured in src/common/config/environment.ts
...
// Note: Group memberships are retrieved from ID token claims (configured in Azure AD)
// No special Graph API permissions needed when "groupMembershipClaims" is set in app manifest

...
const environments: Record<Environment, EnvironmentConfig> = {
  local: {
    ...
    apiBaseUrl: 'http://10.116.15.225:8080',
  },
  development: {
    baseUrl: 'https://apac-rpm-file-server-dev.tech1dev.jainglobal.net',
    redirectUri: 'https://apac-rpm-file-server-dev.tech1dev.jainglobal.net/ui/auth/callback',
    postLogoutRedirectUri: 'https://apac-rpm-file-server-dev.tech1dev.jainglobal.net/ui/login',
    // apiBaseUrl: 'https://apac-rpm-fastapi-dev.tech1dev.jainglobal.net',
    apiBaseUrl: 'http://10.116.15.225:8080',
  },
  production: {
    baseUrl: 'https://apac-rpm-file-server-prod.tech1prod.jainglobal.net',
    redirectUri: 'https://apac-rpm-file-server-prod.tech1prod.jainglobal.net/ui/auth/callback',
    postLogoutRedirectUri: 'https://apac-rpm-file-server-prod.tech1prod.jainglobal.net/ui/login',
    apiBaseUrl: 'http://10.115.12.208:8080',
  },
};
